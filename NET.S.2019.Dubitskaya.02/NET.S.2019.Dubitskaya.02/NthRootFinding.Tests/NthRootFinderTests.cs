...
namespace NthRootFinding.Tests
{
    ...
    public class NthRootFinderTests
    {
        ...
        public void IFindNthRoot_PositiveNumber(double number, long rootPower, double eps, double expected)
        {
        ...
        public void FindNthRoot_ZeroRootPower_ArgumentException()
            => Assert.Throws<ArgumentOutOfRangeException>(() => NthRootFinder.FindNthRoot(9.0, 0, 0.001));
